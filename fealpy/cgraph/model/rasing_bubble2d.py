...
class RasingBubble2D(CNodeType):
    ...
    INPUT_SLOTS = [
        ...
        PortConf("rho0", DataType.FLOAT, title="流体0密度"),
        PortConf("rho1", DataType.FLOAT, title="流体1密度"),
        PortConf("mu0", DataType.FLOAT, title="流体0粘度"),
        PortConf("mu1", DataType.FLOAT, title="流体1粘度"),
    ...
    OUTPUT_SLOTS = [
        ...
        PortConf("rho0", DataType.FLOAT, title="无量纲流体0密度"),
        PortConf("rho1", DataType.FLOAT, title="无量纲流体1密度"),
        PortConf("mu0", DataType.FLOAT, title="无量纲流体0粘度"),
        PortConf("mu1", DataType.FLOAT, title="无量纲流体1粘度"),
